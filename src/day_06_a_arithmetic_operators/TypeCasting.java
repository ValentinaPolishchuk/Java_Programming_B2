...
public class TypeCasting {
    public static void main(String[] args) {
        ...
        byte b = 40;
        int i = b; // the byte value is automatically CONVERTED to int, because is smalled than int
        ...
        int i3 = 500;
        long l1 = i3; // there ia ni issue because long is bigger than int. Im going from small to big. so it will AUTOMATICALLY CAST
        ...
        //with the numbers outside the range DATA LOST
