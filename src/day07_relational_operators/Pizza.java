...
public class Pizza {
    ...
    public static void main(String[] args) {
        ...
        String report = " We ordered " + typeOfPizza + " pizza with the " + numOfSlices + " slices. " + numOfPeople +
                " people ate " + slicesPerPerson + " for each. There were " + slicesLeftOver + " slices left.";
