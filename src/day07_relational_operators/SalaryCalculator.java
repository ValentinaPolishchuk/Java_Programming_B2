...
public class SalaryCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        String taxReport = "State tax rate: " + stateTax + ", Federal tax rate: "
                + federalTax + ", Base salary $" + salary + " \nTax amount: " + stateTax + " for State Tax and " +
                 federalTax + " Federal Tax, in total it is: " + totalTax + " \nAfter tax our salary is: $" +
                salaryAfterTax;
